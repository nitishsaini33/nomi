    ...
    <div className="min-h-dvh flex flex-col relative overflow-hidden bg-[#0B0F19] text-white font-sans">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-8 sm:p-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto mt-[-12vh] sm:mt-[-5vh] flex flex-col items-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-xs sm:text-sm font-medium text-indigo-300 mb-8 sm:mb-10 shadow-sm backdrop-blur-sm animate-float">
